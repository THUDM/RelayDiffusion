...
def get_xformers_flash_attention_op(q, k, v):
    try:
        ...
        print('loading flash attention fail.')
...
class DhariwalUNet(torch.nn.Module):
    def __init__(self,
        ...
        block_kwargs = dict(emb_channels=emb_channels, channels_per_head=64, dropout=dropout, init=init, init_zero=init_zero, eff_attn=eff_attn)
